...
namespace WebApplication2.Controllers
{
    ...
    {
        private static BancoContext _context;

        public VendedorsController(BancoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,Senha")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,Senha")] Vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();
