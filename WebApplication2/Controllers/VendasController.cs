...
namespace WebApplication2.Controllers
{
    public class VendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,nomeCliente,nomeProduto,quantidadeComprada,ValorTotal")] Vendas vendas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,nomeCliente,nomeProduto,quantidadeComprada,ValorTotal")] Vendas vendas)
        {
            if (id != vendas.id)
            {
                return NotFound();
