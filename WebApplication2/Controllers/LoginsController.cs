...
namespace WebApplication2.Controllers
{
    public class LoginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nomeDeUsuario,senha")] Login login)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nomeDeUsuario,senha")] Login login)
        {
            if (id != login.Id)
            {
                return NotFound();
